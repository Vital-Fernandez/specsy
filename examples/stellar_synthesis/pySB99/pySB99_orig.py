...
output_folder = '/home/vital/Astrodata/pystarburst99/compiled_spectra_v2'
...
if plot_isochrones == True:
    ...
    plt.savefig(f'{output_folder}/{SBmodel_name}/isochrones.png')
    ...
    def plot_grid_tracks(track_xparam, track_yparam, grid_xparam_adjinterp_total, grid_yparam_adjinterp_total, title, xlabel, ylabel, length, flipx):
        ...
        plt.tight_layout()
        plt.legend()
        plt.savefig(f'{output_folder}/{SBmodel_name}/isochrones_grid.png')
        return
...
# if plot_SED_with_time == True:
    ...
    #     np.savetxt(f'{output_folder}/{SBmodel_name}' + '/pySB_SED_stellar'+str(int(spec_time))+'_Myr.txt', np.column_stack((spectrum_wave, SED_plot_choice_flux)))
    #     np.savetxt(f'{output_folder}/{SBmodel_name}' + '/pySB_SED_stellar_and_nebular'+str(int(spec_time))+'_Myr.txt', np.column_stack((spectrum_wave, SED_plot_total_choice_flux)))
...
if plot_hires_spectra == True:
    ...
    if save_output == True:
        ...
        np.save(f'{output_folder}/{SBmodel_name}' + '/pySB_hires_spectrum.npy', hires_flux_iterations_send_save)
        np.save(f'{output_folder}/{SBmodel_name}' + '/pySB_hires_norm_spectrum.npy', hires_flux_norm_iterations_send_save)
        # np.savetxt(f'{output_folder}/{SBmodel_name}' + '/pySB_spectrum_'+str(int(spec_time))+'_Myr.txt', np.column_stack((hires_wave_grid, hires_plot_choice_flux)))
        # np.savetxt(f'{output_folder}/{SBmodel_name}' + '/pySB_norm_spectrum_'+str(int(spec_time))+'_Myr.txt', np.column_stack((hires_wave_grid, hires_plot_choice_flux_norm)))
...
if plot_ion_flux == True:
    ...
    plt.tight_layout()
    plt.legend()
    plt.savefig(f'{output_folder}/{SBmodel_name}/HI_ion_flux.png')
    ...
    plt.tight_layout()
    plt.legend()
    plt.savefig(f'{output_folder}/{SBmodel_name}/HeI_ion_flux.png')
    ...
    plt.tight_layout()
    plt.legend()
    plt.savefig(f'{output_folder}/{SBmodel_name}/HeII_ion_flux.png')
...
if plot_wind == True:
    ...
    plt.tight_layout()
    plt.legend()
    plt.savefig(f'{output_folder}/{SBmodel_name}/wind.png')
    ...
    plt.tight_layout()
    plt.legend()
    plt.savefig(f'{output_folder}/{SBmodel_name}/wind_momentum.png')
...
if plot_uv_slope == True:   
    ...
    plt.tight_layout()
    plt.legend()
    plt.savefig(f'{output_folder}/{SBmodel_name}/uv_slope.png')
...
if plot_ew == True:
    ...
    plt.tight_layout()
    plt.legend()
    plt.savefig(f'{output_folder}/{SBmodel_name}/eqw.png')
...
if plot_colours == True:
    ...
    plt.tight_layout()
    plt.legend()
    plt.savefig(f'{output_folder}/{SBmodel_name}/colours.png')
...
if plot_SN_rate == True:
    ...
    plt.tight_layout()
    plt.legend()
    plt.savefig(f'{output_folder}/{SBmodel_name}/SN_rate.png')
    ...
    plt.tight_layout()
    plt.legend()
    plt.savefig(f'{output_folder}/{SBmodel_name}/SN_rate_overtime.png')
